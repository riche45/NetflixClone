...
urlpatterns = [
    ...
    path('series/create/', SeriesCreate.as_view(), name='series_create'),
    ...
    path('movie/<int:pk>/watched/', views.mark_watched, name='mark_watched'),
    path('movie/<int:pk>/favorite/', views.mark_favorite, name='mark_favorite'),
